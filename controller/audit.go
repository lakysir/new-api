...
var auditContentTemplates = map[string]string{
	...
	"quota_application.create": "Created quota application ${application_id} for ${quota}",
	"quota_application.review": "Reviewed quota application ${application_id} (approved: ${approved}, quota: ${quota})",
