...
// UpdateUserUsedQuota adjusts cumulative usage without changing request_count.
// Refunds use this path to reverse a previously recorded task charge while
// preserving the fact that the request itself was made.
