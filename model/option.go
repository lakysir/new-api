...
func InitOptionMap() {
	...
	common.OptionMap["ReferenceImagePricing"] = ratio_setting.ReferenceImagePricing2JSONString()
...
func updateOptionMap(key string, value string) (err error) {
	...
	case "ReferenceImagePricing":
		err = ratio_setting.UpdateReferenceImagePricingByJSONString(value)
	case "CacheRatio":
